...
<body>
    <div class="login-box">
        ...
        <!-- Naye staff members ke liye registration link -->
        <p style="text-align:center; margin-top:15px; color:white;">
            Don't have an account? <a href="sregistration.php" style="color: #4CAF50; text-decoration: underline;">Register here</a>
        </p>
